...
const Main = () => {
    ...
    useEffect(() => {
        ...
        // ref 객체를 가지고 오려면 current를 꼭 적어줘야함!
    ...
    const categoryCheckHandle = (e) => {
        if(e.target.checked) {
            ...
            setSearchParam({...searchParam, categoryIds: [...searchParam.categoryIds.filter(id => id !== e.target.vale)]});
        }
        setRefresh(true);
    }
